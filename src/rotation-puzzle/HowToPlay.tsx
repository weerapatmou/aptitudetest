        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h2 id="howto-title" className="text-lg font-semibold tracking-tight">
                How to play
              </h2>
              <button
                onClick={onClose}
            ...
            <div className="space-y-3 text-sm text-text-dim leading-relaxed">
              <p>
                <span className="text-text font-medium">Find the option</span> that is the
                original figure rotated by <span className="text-accent">any</span> angle. The
                specific rotation doesn't matter — only the structural identity.
              </p>
              <p>
                <span className="text-accent">Reject any option</span> with: a mirror flip,
                swapped elements, missing or extra elements, altered shapes (e.g. circle becomes
                an oval), distorted proportions, or shifted positions.
              </p>
