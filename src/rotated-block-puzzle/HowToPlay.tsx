    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="rb-howto-title"
        >
          <motion.div
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h2 id="rb-howto-title" className="text-lg font-semibold tracking-tight">
                How to play
              </h2>
              <button
                onClick={onClose}
            ...
            <div className="space-y-3 text-sm text-text-dim leading-relaxed">
              <p>
                Each question shows a 3D block on the left. Exactly one of the five choices
                (<span className="text-accent">A, B, C, D, E</span>) is the{' '}
                <span className="text-text">same block turned to a different angle</span>. Pick it.
              </p>
              <p>
                The other four can never be made to match by turning. They are{' '}
                <span className="text-text">mirror images</span>, or have a block moved, added or
                removed, or stretched out of proportion. Rotate the block in your head and compare.
              </p>
              <p>
                ...
                wrong block is different. Difficulty labels stay hidden until you submit.
              </p>
            </div>
          </motion.div>
        </motion.div>
